...
- “命名源 XYZ”视图接入 Elden Ring Compass 生成的 419 个赐福实体 `mapId + x/y/z` 坐标；它们按 `source_map_local_xyz` 单独显示，不与 MapForGoblins 坐标混叠，378 个记录带有正式赐福身份候选，全部保持 `routeable: false`。
