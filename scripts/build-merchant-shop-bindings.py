...
def build(source: Path, spawn_path: Path, source_url: str | None, source_commit: str | None) -> dict[str, Any]:
    ...
    for row in source_rows:
        ...
        named = bool(row.get("merchantName"))
        endpoint = {
            "id": (
    ...
    payload = {
        ...
        "builtFrom": {
            ...
            "policy": "retain every talk-row seller binding; unnamed sellers remain unresolved",
        },
        "stats": {
...
def main() -> int:
    ...
    payload = build(args.source, args.enemy_spawns, args.source_url, args.source_commit)
