...
python scripts/build-local-map-coverage-classification.py --coverage data/v1/entities/local-nva-coverage-audit.json --nva data/v1/entities/local-nva-navmesh-index.json --output data/v1/entities/local-map-coverage-classification.json
