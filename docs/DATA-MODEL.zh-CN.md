...
python scripts/build-local-map-coverage-classification.py --coverage data/v1/entities/local-nva-coverage-audit.json --nva data/v1/entities/local-nva-navmesh-index.json --maps-dir <快照>/extracted/parsed-mapstudio-all-v2/maps --output data/v1/entities/local-map-coverage-classification.json
